...
if(isset($_POST["submit"]))
{
 ...
 if(empty($_POST["hplay"]))
 {
  $error .= '<p><label class="text-danger">Number of times played is required</label></p>';
 }
 else
 {
  $hplay = clean_text($_POST["hplay"]);
 }
  ...
  <div class="container">
   ...
   <div class="col-md-6" style="margin:0 auto; float:none;">
    <form method="post">
     ...
     <div class="form-group">
      <label>Enter the number of times you played </label> <br>
      <input type="text" name="hplay" placeholder="Enter the number of times you played" value="<?php echo $hplay; ?>" />
     </div>
     <div class="form-group">
